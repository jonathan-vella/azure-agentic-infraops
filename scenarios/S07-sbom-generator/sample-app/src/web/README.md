...
This is a [Create React App](https://github.com/facebook/create-react-app) based repo that comes with
Fluent UI pre-installed!
...
etc) right into your project so you have full control over them.
